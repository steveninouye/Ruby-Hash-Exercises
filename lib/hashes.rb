...
def biodiversity_index(specimens)
    ...
    specie_count = Hash.new(0)
    specimens.each{|el| specie_count[el] += 1}
    largest_population_size = specie_count.max_by {|k,v| v }[1]
    smallest_population_size = specie_count.min_by {|k,v| v }[1]
